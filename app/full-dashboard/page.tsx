...
export default function FullDashboardPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center transition-colors duration-500">
        <div className="text-center">
          <RefreshCw className="w-8 h-8 animate-spin text-pink-600 dark:text-pink-400 mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-colors duration-500">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-xl font-bold text-gray-800 dark:text-pink-100">Skinsey Dashboard</h1>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <ThemeToggle />
              <Button variant="ghost" size="icon" className="text-gray-600 dark:text-slate-400 hover:text-pink-600 dark:hover:text-pink-400">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-pink-100 mb-2">
            Good {timeSlot}, {dashboardData?.user.name || "User"}! 👋
          </h2>
          <p className="text-gray-600 dark:text-slate-400">Here's your comprehensive skin health overview for today</p>
        </div>

        {/* Main Dashboard Tabs */}
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="flex overflow-x-auto no-scrollbar bg-white dark:bg-slate-900 border border-pink-100 dark:border-pink-900/30">
            <TabsTrigger
              value="overview"
              className="flex-shrink-0 px-4 py-2 text-center data-[state=active]:bg-pink-100 dark:data-[state=active]:bg-pink-950/40 data-[state=active]:text-pink-700 dark:data-[state=active]:text-pink-400 dark:text-slate-400"
            >
              Overview
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 bg-gradient-to-r from-pink-50 to-rose-50 dark:from-slate-900 dark:to-slate-800">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        <CardTitle className="text-2xl text-gray-800 dark:text-pink-100">Skin Health Score</CardTitle>
                        <CardDescription className="dark:text-slate-300">Based on your recent analysis</CardDescription>
                      </div>
                      <div className="text-right">
                        <div className="text-4xl font-bold text-pink-600 dark:text-pink-400">
                          {dashboardData?.metrics.skinHealthScore || 78}
                        </div>
                        <div className="text-sm text-gray-600 dark:text-slate-400">out of 100</div>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Quick Actions</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <Button
                        variant="outline"
                        className="h-20 border-pink-200 dark:border-pink-900/50 hover:bg-pink-50 dark:hover:bg-pink-950/20 rounded-xl flex flex-col gap-2 bg-transparent dark:text-pink-400"
                        asChild
                      >
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Recent Activity</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {(dashboardData?.recentActivity || []).map((activity, index) => (
                        <div key={index} className="flex items-center gap-4 p-3 bg-pink-50 dark:bg-pink-950/20 rounded-lg">
                          <div className="w-10 h-10 bg-pink-200 dark:bg-pink-900/40 rounded-full flex items-center justify-center">
                            <Camera className="w-5 h-5 text-pink-600 dark:text-pink-400" />
                          </div>
                          <div className="flex-1">
                            <p className="font-medium text-gray-800 dark:text-pink-100">{activity.title}</p>
              ...
              <div className="space-y-6">
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-lg text-gray-800 dark:text-pink-100">Today's Routine</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-gray-800 dark:text-slate-200">Morning Routine</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-gray-800 dark:text-slate-200">Evening Routine</p>
                        <p className="text-sm text-gray-600 dark:text-slate-400">{overviewEveningCompleted}/{overviewEveningTotal} completed</p>
                      </div>
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full mt-3 border-pink-200 dark:border-pink-900/50 text-pink-600 dark:text-pink-400 hover:bg-pink-50 dark:hover:bg-pink-950/20 bg-transparent"
                    >
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-lg text-gray-800 dark:text-pink-100">Appointments</CardTitle>
                      <div className="flex items-center gap-2">
                        <Button
                          variant="ghost"
                          size="sm"
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {dashboardData?.appointments && dashboardData.appointments.length > 0 ? (
                        <>
                          {dashboardData.appointments.slice(0, 2).map((apt, index) => (
                            <div key={index} className="p-3 bg-pink-50 dark:bg-pink-950/20 rounded-lg border border-pink-100 dark:border-pink-900/30">
                              <div className="flex items-center justify-between mb-2">
                                <p className="font-medium text-gray-800 dark:text-pink-100">{apt.doctorName}</p>
                                <Badge
                                  variant={apt.status === 'confirmed' ? 'default' : 'secondary'}
                                  className={apt.status === 'confirmed' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400'}
                                >
                                  {apt.status === 'confirmed' ? 'Confirmed' : apt.status}
                                </Badge>
                              </div>
                              <p className="text-sm text-gray-600 dark:text-slate-300 mb-1">{apt.specialty}</p>
                              <div className="flex items-center justify-between mb-2">
                                <p className="text-sm text-gray-500 dark:text-slate-400">{apt.time}</p>
                                <Badge className="bg-pink-100 dark:bg-pink-950 text-pink-700 dark:text-pink-400 hover:bg-pink-100">
                                  {new Date(apt.date).toLocaleDateString()}
                                </Badge>
                              </div>
                              {/* Appointment Actions */}
                              <div className="flex items-center gap-2 pt-2 border-t border-pink-100 dark:border-pink-900/30">
                        ...
                        <div className="text-center py-6">
                          <Calendar className="w-8 h-8 text-gray-400 dark:text-slate-500 mx-auto mb-2" />
                          <p className="text-sm text-gray-500 dark:text-slate-400 mb-3">No appointments scheduled</p>
                          <Button
                            variant="outline"
                            size="sm"
                            className="border-pink-200 dark:border-pink-900/50 text-pink-600 dark:text-pink-400 hover:bg-pink-50 dark:hover:bg-pink-950/20"
                            asChild
                          >
                            <Link href="/book-appointment">
                      ...
                      <Button
                        variant="outline"
                        className="w-full border-pink-200 dark:border-pink-900/50 text-pink-600 dark:text-pink-400 hover:bg-pink-50 dark:hover:bg-pink-950/20 bg-transparent"
                        asChild
                      >
                        <Link href="/book-appointment">
                          {dashboardData?.appointments && dashboardData.appointments.length > 0
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-lg text-gray-800 dark:text-pink-100">Today's Tip</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="p-4 bg-gradient-to-r from-pink-50 to-rose-50 dark:from-slate-900 dark:to-slate-800 rounded-lg">
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-pink-200 dark:bg-pink-900/40 rounded-full flex items-center justify-center flex-shrink-0">
                          <Shield className="w-4 h-4 text-pink-600 dark:text-pink-400" />
                        </div>
                        <div>
                          <p className="font-medium text-gray-800 dark:text-pink-100 mb-1">UV Protection</p>
          ...
          <TabsContent value="reminders" className="space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-pink-100">Reminders & Tasks</h3>
              <Dialog open={showAddReminder} onOpenChange={setShowAddReminder}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle className="dark:text-pink-100">Add New Reminder</DialogTitle>
                  </DialogHeader>
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="title" className="dark:text-pink-100">Title</Label>
                      <Input
                        id="title"
                        value={newReminder.title}
                        onChange={(e) => setNewReminder({ ...newReminder, title: e.target.value })}
                        placeholder="e.g., Take medication"
                        className="dark:bg-slate-900 dark:border-pink-900/30"
                      />
                    </div>
                    <div>
                      <Label htmlFor="description" className="dark:text-pink-100">Description</Label>
                      <Textarea
                        id="description"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="dueDate" className="dark:text-pink-100">Due Date</Label>
                        <Input
                          id="dueDate"
                          type="datetime-local"
                          value={newReminder.dueDate}
                          onChange={(e) => setNewReminder({ ...newReminder, dueDate: e.target.value })}
                          className="dark:bg-slate-900 dark:border-pink-900/30 [color-scheme:dark]"
                        />
                      </div>
                      <div>
                        <Label htmlFor="type" className="dark:text-pink-100">Type</Label>
                        <Select
                          value={newReminder.type}
                          onValueChange={(value) => setNewReminder({ ...newReminder, type: value })}
                        >
                          <SelectTrigger className="dark:bg-slate-900 dark:border-pink-900/30">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent className="dark:bg-slate-900 dark:border-pink-900/30">
            ...
            <div className="grid gap-4">
              {reminders.map((reminder) => (
                <Card key={reminder._id} className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-800 dark:text-pink-100">{reminder.title}</p>
                          <p className="text-sm text-gray-600 dark:text-slate-300">{reminder.description}</p>
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className={reminder.completed ? "text-green-600 dark:text-green-400" : "text-gray-600 dark:text-slate-400"}
                        >
              ...
              {reminders.length === 0 && (
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">No reminders yet</p>
                    <p className="text-sm text-gray-500 dark:text-slate-500">Add your first reminder to stay on track</p>
                  </CardContent>
                </Card>
              )}
            </div>
          ...
          <TabsContent value="weather" className="space-y-6">
            {weatherData && (
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Current Weather</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="dark:text-slate-300">{weatherData.currentWeather?.humidity ?? "N/A"}%</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Eye className="w-5 h-5 text-yellow-600 dark:text-yellow-400" />
                          <span className="dark:text-slate-300">UV {weatherData.currentWeather?.uvIndex ?? "N/A"}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Wind className="w-5 h-5 text-gray-600 dark:text-slate-400" />
                          <span className="dark:text-slate-300">{weatherData.currentWeather?.windSpeed ?? "N/A"} km/h</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-green-100 dark:border-green-900/30 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Skincare Recommendations</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div>
                      <h3 className="font-medium text-gray-700 dark:text-slate-200">Immediate</h3>
                      <ul className="list-disc ml-5 text-sm dark:text-slate-300">
                        {weatherData.recommendations?.immediate?.length ? (
                          ...
                          <li className="text-gray-500 dark:text-slate-500">No immediate recommendations</li>
                        )}
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-700 dark:text-slate-200">Daily</h3>
                      <ul className="list-disc ml-5 text-sm dark:text-slate-300">
                        {weatherData.recommendations?.daily?.length ? (
                          ...
                          <li className="text-gray-500 dark:text-slate-500">No daily recommendations</li>
                        )}
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-700 dark:text-slate-200">Risk Factors</h3>
                      <ul className="list-disc ml-5 text-sm text-red-600 dark:text-red-400">
                        {weatherData.riskFactors?.length ? (
                          weatherData.riskFactors.map((r: string, i: number) => (
                            <li key={i}>{r}</li>
                          ))
                        ) : (
                          <li className="text-gray-500 dark:text-slate-500">No risk factors detected</li>
                        )}
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-700 dark:text-slate-200">Tips</h3>
                      <ul className="list-disc ml-5 text-sm dark:text-slate-300">
                        {weatherData.tips?.length ? (
                          ...
                          <li className="text-gray-500 dark:text-slate-500">No tips available</li>
                        )}
                      </ul>
                    </div>
                  </CardContent>
                ...
                <Card className="border-yellow-100 lg:col-span-2">
                  ...
                  <Card className="border-yellow-100 dark:border-yellow-900/30 lg:col-span-2 dark:bg-slate-900/50 glow-card">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800 dark:text-pink-100 flex items-center gap-2">
                        <Clock className="w-5 h-5 text-gray-600 dark:text-slate-400" />
                        Time-Based Routine ({clock})
                        <Badge variant="outline" className="ml-auto capitalize dark:border-pink-900/30 dark:text-pink-400">
                          {timeSlot}
                        </Badge>
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      {weatherData?.recommendations?.timeBased?.[timeSlot]?.length ? (
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
                            <div className="w-8 h-8 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                              {timeSlot === "morning" && <Sun className="w-4 h-4 text-yellow-600 dark:text-yellow-400" />}
                              {timeSlot === "afternoon" && <Activity className="w-4 h-4 text-orange-600 dark:text-orange-400" />}
                              {timeSlot === "evening" && <Moon className="w-4 h-4 text-purple-600 dark:text-purple-400" />}
                              {timeSlot === "night" && <Zap className="w-4 h-4 text-blue-600 dark:text-blue-400" />}
                            </div>
                              ...
                              {weatherData.recommendations.timeBased[timeSlot].map(
                                (s: string, i: number) => (
                                  <li key={i} className="flex items-start gap-2">
                                    ...
                                    <span className="dark:text-slate-300">{s}</span>
                                  </li>
                                )
                              )}
                            </ul>
                          ...
                          <div className="mt-4 pt-4 border-t border-yellow-100 dark:border-yellow-900/30">
                            <p className="text-sm text-gray-600 dark:text-slate-400">
                              <span className="font-medium dark:text-pink-100">Weather Note:</span> These recommendations
                        ...
                        <div className="text-center py-8">
                          <Clock className="w-10 h-10 text-gray-400 dark:text-slate-500 mx-auto mb-3" />
                          <p className="text-gray-600 dark:text-slate-400">No routine available for this time</p>
                ...
                {/* Seasonal Tips */}
                <Card className="border-purple-100 dark:border-purple-900/30 lg:col-span-2 dark:bg-slate-900/50 glow-card">
                  <CardHeader>
                    <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Seasonal Tips</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="list-disc ml-5 text-sm dark:text-slate-300">
                      {weatherData.recommendations?.seasonal?.length ? (
                        ...
                        <li className="text-gray-500 dark:text-slate-500">No seasonal tips available</li>
                      )}
                    </ul>
                  </CardContent>
                </Card>
          ...
          <TabsContent value="community" className="space-y-6">
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                <CardHeader>
                  <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Community Tips</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    {communityTips.length === 0 && (
                      <p className="text-sm text-gray-500 dark:text-slate-500">No tips yet. Be the first to share!</p>
                    )}
                    <div className="space-y-3">
                      {communityTips.map((tip, idx) => (
                        <div key={idx} className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 rounded-lg">
                          <div className="flex items-start gap-4">
                            <Avatar className="w-10 h-10 border-2 border-white dark:border-slate-700 shadow-sm">
                              <AvatarImage src="/placeholder-user.jpg" />
                              <AvatarFallback className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300">
                                {(tip.userName || 'U').slice(0, 2).toUpperCase()}
                              </AvatarFallback>
                            </Avatar>
                            <div className="flex-1">
                              <p className="font-semibold text-gray-800 dark:text-pink-100">
                                {tip.userName || 'Anonymous'}
                              </p>
                              <p className="text-sm text-gray-600 dark:text-slate-300 mt-1">{tip.content}</p>
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  {(tip.ownerEmail && tip.ownerEmail === dashboardData?.user?.email) && (
                                    <Button
                                      size="sm"
                                      variant="ghost"
                                      onClick={() => handleDeleteTip((tip._id as string) || (tip.id as string))}
                                      className="text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/20"
                                    >
                                      <Trash2 className="w-3 h-3 mr-1" />
                                      Delete
                                    </Button>
              ...
              <Card className="border-pink-100 dark:border-pink-900/30 dark:bg-slate-900/50 glow-card">
                <CardHeader>
                  <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Community Stats</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-pink-50 dark:bg-pink-950/20 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium dark:text-slate-200">Active Members</span>
                      </div>
                      <span className="text-lg font-bold text-pink-600 dark:text-pink-400">{communityStats?.activeMembers ?? '—'}</span>
                    </div>

                    <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-950/20 rounded-lg">
                      <div className="flex items-center gap-3">
                        <Lightbulb className="w-5 h-5 text-green-600 dark:text-green-400" />
                        <span className="font-medium dark:text-slate-200">Tips Shared</span>
                      </div>
                      <span className="text-lg font-bold text-green-600 dark:text-green-400">{communityStats?.tipsShared ?? '—'}</span>
                    </div>

                    <div className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                      <div className="flex items-center gap-3">
                        <Activity className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                        <span className="font-medium dark:text-slate-200">Success Stories</span>
                      </div>
                      <span className="text-lg font-bold text-blue-600 dark:text-blue-400">{communityStats?.successStories ?? '—'}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="border-blue-100 dark:border-blue-900/30 dark:bg-slate-900/50 glow-card">
              <CardHeader>
                <CardTitle className="text-xl text-gray-800 dark:text-pink-100">Success Stories</CardTitle>
                <CardDescription className="dark:text-slate-400">Real results shared by the community</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="mb-4 grid gap-2 md:grid-cols-[1fr_auto]">
                  ...
                  <div className="md:col-span-2 flex gap-2">
                    <Input
                      ...
                      className="flex-1 dark:bg-slate-900 dark:border-pink-900/30"
                    />
                ...
                {successStories.length === 0 && (
                  <p className="text-sm text-gray-500 dark:text-slate-500">No success stories yet. Be the first to share!</p>
                )}
                <div className="space-y-4">
                  {successStories.map((story, idx) => (
                    <div key={idx} className="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-slate-900 dark:to-slate-800 rounded-lg">
                      <div className="flex items-start gap-4">
                        <Avatar className="w-10 h-10 border-2 border-white dark:border-slate-700 shadow-sm">
                          <AvatarImage src="/placeholder-user.jpg" />
                          <AvatarFallback className="bg-pink-100 dark:bg-pink-900 text-pink-700 dark:text-pink-300">
                            {(story.userName || 'U').slice(0, 2).toUpperCase()}
                          </AvatarFallback>
                        </Avatar>
                        <div className="flex-1">
                          <p className="font-semibold text-gray-800 dark:text-pink-100">{story.title || 'Success Story'}</p>
                          <p className="text-sm text-gray-600 dark:text-slate-300 mt-1">{story.content}</p>
                          <div className="flex items-center justify-between mt-3">
                            ...
                            {(story.ownerEmail && story.ownerEmail === dashboardData?.user?.email) && (
                              <Button
                                size="sm"
                                variant="ghost"
                                onClick={() => handleDeleteSuccessStory((story._id as string) || (story.id as string))}
                                className="text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/20"
                              >
                                <Trash2 className="w-3 h-3 mr-1" />
                                Delete
